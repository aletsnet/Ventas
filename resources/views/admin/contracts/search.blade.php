                                    ...
                                    <select name="tipo" id="tipo" class="form-select" placeholder="Tipo">
                                        @isset($tipos)
                                            @foreach ($tipos as $key => $item)
                                                <option value="{{ $item->valor }}"> {{ $item->opcion }} </option>
                                            @endforeach
                                        @endisset
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <select name="estado" id="estado" class="form-select" placeholder="Contrato"
                                        onchange="load_select(this, 'municipio','{!! \asset('list/municipios') !!}'); load_select(this, 'distrito','{!! \asset('list/distrito') !!}');"
                                    >
                                        @isset($estados)
    ...
    const edit_item = (id) => {
        ...
        axios({
            ...
            data: {}
                    ...
                    elements.name.value = result.data.users.name;
                    elements.email.value = result.data.users.email;
                    elements.telefono.value = result.data.telefono;
                    selects.estado.value = result.data.estado;
                    load_select(selects.estado, 'municipio','{!! \asset('list/municipios') !!}', result.data.municipio);
                    load_select(selects.estado, 'distrito','{!! \asset('list/distrito') !!}', result.data.distrito);
                    id_row.value = result.data.id;
